...
*See [Day 2: From One App to an Ecosystem](WIP_Journey_Day2.md), [Day 3: The Sparring Match on a Train](WIP_Journey_Day3.md), [Day 4: From Hobbits to Deployment](WIP_Journey_Day4.md), and [Day 4½: The Morning Intermezzo](WIP_Journey_Day4_Intermezzo.md) for what happens next.*
