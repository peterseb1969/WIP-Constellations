...
*See [Day 2: From One App to an Ecosystem](WIP_Journey_Day2.md), [Day 3: The Sparring Match on a Train](WIP_Journey_Day3.md), [Day 4: From Hobbits to Deployment](WIP_Journey_Day4.md), [Day 4½: The Morning Intermezzo](WIP_Journey_Day4_Intermezzo.md), and [Day 5: The Reporter's Blind Spot](WIP_Journey_Day5.md) for what happens next.*
